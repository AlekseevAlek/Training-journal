...
- Метод filter_data фильтрует данные по дате.

- Метод filter_by_exercise фильтрует данные по упражнению.

- Метод export_to_csv экспортирует все данные в CSV файл.

- Метод import_from_csv импортирует данные из CSV файла.

- Метод edit_entry редактирует выбранную запись.

- Метод delete_entry удаляет выбранную запись.

- Метод  calculate_monthly_statistics расчитывает статистику по упражнениям за месяц.

- Метод display_statistics отображает статистику по упражнениям.

- Метод prepare_data_for_visualization подготавливает данные для визуализации.

- Метод visualize_progress визуализирует данные в виде графика.
